...
const SKILL_PACKS = [
  ...
  },
  {
    ...
    description:
      "Reusable design systems, landing templates, UI micro-patterns, and craft checklists — DESIGN.md + HTML/CSS/TS sources. Unzip and reuse.",
    iconUrl: "https://lizliz.xyz/assets/icons/templates.svg",
    ogImage: "https://lizliz.xyz/og/templates.png",
  },
];
